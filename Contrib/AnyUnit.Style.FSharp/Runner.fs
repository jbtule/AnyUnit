...
/// name to fall back on here.
let run (platformId: string) (fixtureName: string) (tests: Test list) : ResultsFile =
    ...
    for t in tests do
        let testMeta = TestMeta(Name = t.Name, UniqueName = fixtureName + "." + t.Name)
