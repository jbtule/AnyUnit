...
namespace AnyUnit.Style.Xunit
{
    ...
    public class UnlabeledFixtureAttribute:Run.Attributes.TestFixtureAttributeBase
    {
            ...
            get
            {
                return t =>
                {
                    ...
                    var useType = t.GetInterfaces()
                        .FirstOrDefault(it => it.IsGenericType && it.GetGenericTypeDefinition() == typeof(IUseFixture<>));
        ...
        {
            return (type.GetCustomAttributes(typeof (TraitAttribute), true)
        ...
        {
            return (type.GetCustomAttributes(typeof(TraitAttribute), false)
                           .OfType<TraitAttribute>()
