...
namespace SatelliteRunner.Shared
{
    public partial class RunTests
    {
        ...
        private static Assembly LoadAssembly(string id, string file){
            ...
            try{
                ...
                throw new Exception(String.Format("{0} failed to load {1}", id, file),ex);
            }
        }
        ...
        public void Run(string id, string url, string[] dlls)
        {
...
#elif x86
            if(Environment.Is64BitProcess){
                throw new Exception("This runner is expected to run 32bit");
            }
#endif
            ...
            var am = dlls.Select(f=>LoadAssembly(id, f)).ToList();
